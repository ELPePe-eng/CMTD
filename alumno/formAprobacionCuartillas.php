      ...
      <div class="contenedormenu">
        ...
        <nav class="menu">
          ...
          <main>
            ...
            <section id="infoBien">
              <br><br>
              <h3>Aprobación de cuartillas</h3><br>
              <center>
                ...
                <fieldset id="fieldset3"><br>
                  <form class="" action="index.html" method="post">
                    ...
                    <center>
                      Metodo de titulacion:<br><br>
                      <input type="number" name="" > <br> <br>
                      Tema<br><br>
                      <input type="text" name=""><br><br>
                      Nombre del estudiante:<br><br>
                      <input type="text" name=""><br><br>
                      No. de cuartillas:<br><br>
                      <input type="number" name=""><br><br>
                      Haz click en el siguiente botón para descargar el formato:
                        <br><br>
                      <div class="custom-input-file col-md-6 col-sm-6 col-xs-6">
                        <input type="file" id="AprobacionCuartillas" class="input-file" value="" download="">
