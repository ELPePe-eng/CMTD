            ...
            <section id="infoBien">
              ...
              <center>
                ...
                <fieldset id="fieldset3"><br>
                  <form action="/CMTD/doc1/SAMetodo.php" method="POST" accept-charset="utf-8" class="btn-log">

                    <center>
                      %Si el asesor no ha verificado o aceptado el metodo de tiulación:%
                      <br>Aún no tienes disponible este formato.<br>
                      <br>
                      %Si ya lo acepto %<br>
                      Haz click en el siguente botón para descargar el formato:<br><br>
                      <input type="submit" name="" value="Solicitar" id="btn">
