...
<center>
          <section id="infoBien">
            ...
            <fieldset id="fieldset4">
              ...
              Buscar por titulo: <input type="search" name="" value="">
              <input type="button" name="" value="Buscar" id="botB" onclick="mostrar()">
              </form>
              ...
              <div id="flotante" style="display:none;">
                ...
                <ol id="lista3">
                <a href="AsesoriasAgregarAsesoriaDocente2.html"><li>Alumno - Nombre del proyecto - metodo de titulacion</li></a>
                <a href="AsesoriasAgregarAsesoriaDocente2.html"><li>Alumno - Nombre del proyecto - metodo de titulacion</li></a>
                <a href="AsesoriasAgregarAsesoriaDocente2.html"><li>Alumno - Nombre del proyecto - metodo de titulacion</li></a>
                <a href="AsesoriasAgregarAsesoriaDocente2.html"><li>Alumno - Nombre del proyecto - metodo de titulacion</li></a>
                <a href="AsesoriasAgregarAsesoriaDocente2.html"><li>Alumno - Nombre del proyecto - metodo de titulacion</li></a>
